...
virsorter run -w MLP_oil10kscaf.out -i MLP_oil10kscaf.fasta  -j 60 --prep-for-dramv --min-length 10000 --include-groups dsDNAphage,NCLDV,RNA,ssDNA,lavidaviridae -d /home/PTPE2/User/liupf/test_data/db  all  &> MLP_oil10kscaf—vs2_all.log
```
